...
print "There are Following Features Available to us:"
...
print "Number of persons with known Email: ", countEmail
print "Number of POIs with known Email: ", countPOIEmail
...
'''
Once the new data points are added, do you think a supervised classification algorithm 
might interpret NaN for total_payments as a clue that someone is a POI
Yes Ofcourse!
Adding in the new POIs in this example, none of whom we have financial information for, 
has introduced a subtle problem, that our lack of financial information about them can be 
picked up by an algorithm as a clue that theyre POIs. Another way to think about this is 
that theres now a difference in how we generated the data for our two classes--non-POIs 
